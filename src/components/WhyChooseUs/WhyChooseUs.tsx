...
export default function WhyChooseUs() {
  ...
  return (
    <section className="bg-foreground w-full px-4 py-16">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl text-black font-bold mb-3 md:text-4xl">Why Choose Us Over Others?</h2>
          <p className="text-gray">See how our program delivers results where others fall short</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 md:grid-cols-2 ">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-card-foreground  p-6 rounded-lg shadow-sm hover:shadow-md transition-all"
            >
              ...
              <div className="grid grid-cols-2 gap-2 mb-4 ">
                <div className="flex border bg-foreground justify-center p-3 rounded items-center">
                  <span className="text-sm font-medium text-black">HighPaidJobs</span>
                </div>
                <div className="flex bg-foreground justify-center p-3 rounded items-center border">
                  <span className="text-sm font-medium text-black">Others</span>
                </div>
                <div className="flex bg-foreground border justify-center p-3 rounded items-center">
              ...
              {/* Highlight */}
              <div className="bg-foreground p-3 rounded text-gray text-sm">{feature.highlight}</div>
            </div>
          ))}
        </div>

        <div className="text-center mt-12">
          <h3 className="text-xl font-semibold mb-4 text-black">Ready to experience the HighPaidJobs difference?</h3>
